...
/**
 * Page component that displays a list of the top rated movies from TMDB.
 *
 * I fetch the highest-rated movies from the TMDB API and render them in a grid layout. I use the
 * useMovieList hook to handle data fetching, caching, and managing loading/error states.
 * Each movie card includes an "Add to Favorites" button, allowing users to save their favorite
 * highly-rated movies for quick access later.
 *
 ...
 *
 * @component
 * @returns {React.ReactElement} A page component displaying top rated movies with the ability
...
const TopRatedMoviesPage = () => {
  // I fetch the list of top rated movies using the useMovieList hook, which handles
